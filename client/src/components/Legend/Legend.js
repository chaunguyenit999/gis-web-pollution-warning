      ...
      <div className="legend" >
        <table>
          <tbody style={{backgroundColor: "white"}}>
              ...
              <tr><td className="marker"><img src={orangeMarker} alt=""></img></td><td style={{ backgroundColor: "#ff7e00", color: "#000000", padding: "0px 9px" }}>Không lành mạnh cho <br/>các nhóm nhạy cảm</td></tr>
              <tr><td className="marker"><img src={greyMarker} alt=""></img></td><td style={{ backgroundColor: "gray", color: "#ffffff", padding: "0px 9px" }}>Không lành mạnh</td></tr>
              <tr><td className="marker"><img src={redMarker} alt=""></img></td><td style={{ backgroundColor: "#ff0000", color: "#ffffff", padding: "0px 9px" }}>Rất không lành mạnh</td></tr>
