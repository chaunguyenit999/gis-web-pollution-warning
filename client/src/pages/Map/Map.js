                ...
                return (
                    <div className='map-container'>
                        ...
                        <div className="body-wrapper">
                            ...
                            <Mapbody data={dataMap} listOfYear={year} listOfMonth={month} selectedMonth={selectedMonth} selectedYear={selectedYear} center={centerLatLng} typeOfPollutions={pollutionState} selectedDataType={selectedDataType} />
                        </div>
                    </div>
                );
            }
