      ...
      success: function (res) {
        ...
        if (option.chartType == "doughnut") {
          var data = res.map((item) => ({
            o3_AQI: item.o3.aqi,
            pm2_5_AQI: item.pm2_5.aqi,
            pm10_AQI: item.pm10.aqi,
            co_AQI: item.co.aqi,
          ...
          var avg_o3_AQI =
            data.reduce((sum, item) => sum + item.o3_AQI, 0) / data.length;
          var avg_pm2_5_AQI =
            data.reduce((sum, item) => sum + item.pm2_5_AQI, 0) / data.length;
          var avg_pm10_AQI =
            data.reduce((sum, item) => sum + item.pm10_AQI, 0) / data.length;
          var avg_co_AQI =
            data.reduce((sum, item) => sum + item.co_AQI, 0) / data.length;
          var avg_so2_AQI =
          ...
          var newData = [
            { value: avg_o3_AQI.toFixed(0), name: "O3" },
            { value: avg_pm2_5_AQI.toFixed(0), name: "PM2.5" },
            { value: avg_pm10_AQI.toFixed(0), name: "PM10" },
            { value: avg_co_AQI.toFixed(0), name: "CO" },
